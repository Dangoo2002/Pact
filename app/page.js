...
import { 
  ...
  Star, Shield, Cloud, Lock, LogOut, User
} from 'lucide-react';
...
export default function HomePage() {
  ...
  const features = [
    { icon: Brain, title: 'Intelligent Gap Analysis', description: 'PACT AI identifies exactly which programming concepts you struggle with.', tags: ['Real-time', 'Pattern Recognition'] },
    ...
    { icon: Zap, title: 'AI-Powered Insights', description: 'Get instant, human-like explanations with actionable advice from advanced AI.', tags: ['24/7 AI', 'Code Review'] },
  ...
  const technologies = [
    { name: 'PACT AI', description: 'Advanced LLM', icon: Cpu },
              ...
              {status === 'loading' ? (
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10">
                    ...
                    <span className="text-sm text-gray-300">{session?.user?.name?.split(' ')[0] || 'User'}</span>
                  </div>
                  <Link href={getDashboardPath()}>
                    <Button className="backdrop-blur-xl bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/30 rounded-full px-5 py-2 text-sm">
                      Dashboard
                    </Button>
                  </Link>
                  <button
                    onClick={handleSignOut}
                    className="backdrop-blur-xl bg-white/5 hover:bg-white/10 border border-white/10 rounded-full px-4 py-2 text-sm text-gray-400 hover:text-white transition flex items-center gap-1"
                  >
          ...
          <div className="md:hidden border-t border-white/10 bg-[#0A1628]/95 backdrop-blur-xl">
            <div className="p-4 flex flex-col gap-3">
              ...
              {status === 'loading' ? (
                ...
                <>
                  <div className="flex items-center gap-2 px-3 py-2 rounded-full bg-white/5 border border-white/10 mb-2">
                    <User className="w-4 h-4 text-blue-400" />
                  ...
                  <Link href={getDashboardPath()} onClick={() => setMobileMenuOpen(false)}>
                    <Button className="w-full backdrop-blur-xl bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/30 rounded-full py-2">
                      Dashboard
                    </Button>
                  </Link>
                  <button
                    ...
                    className="w-full backdrop-blur-xl bg-white/5 hover:bg-white/10 border border-white/10 rounded-full py-2 text-gray-400 hover:text-white transition flex items-center justify-center gap-2"
                  >
                    <LogOut className="w-4 h-4" />
                    Sign Out
                  </button>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
              <div>
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-2xl mb-8 leading-relaxed">
                  ...
                  Powered by advanced AI for deep code understanding and intelligent feedback.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  {!isAuthenticated ? (
                    ...
                    <Link href={getDashboardPath()}>
                      <Button className="backdrop-blur-xl bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/30 rounded-full px-6 py-2 text-sm">
                        Go to Dashboard
                        <ArrowRight className="w-3 h-3 ml-1" />
                      </Button>
                    </Link>
              ...
              <div>
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="text-xs text-gray-500 font-mono">PACT AI Analytics</div>
                  </div>
          ...
          <div className="w-full px-4 sm:px-6 lg:px-8 py-16 md:py-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {[
                ...
                { step: '02', title: 'AI-Powered Analysis', desc: 'Advanced AI analyzes your code and identifies gaps' },
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 py-16 md:py-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-base md:text-lg text-gray-400 mb-8 max-w-2xl mx-auto">
              Join thousands of students using PACT with advanced AI to master programming through personalized learning.
            </p>
          ...
          <div className="w-full px-4 sm:px-6 lg:px-8 py-8 md:py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-7xl mx-auto pb-8">
              <div>
                ...
                <p className="text-sm text-gray-500 leading-relaxed">Personalized Adaptive Coding Tutor — Powered by Advanced AI.</p>
              </div>
              <div>
            ...
            <div className="text-center text-xs text-gray-500 pt-8 border-t border-white/10">
              <p>&copy; 2026 PACT - Personalized Adaptive Coding Tutor. Powered by Advanced AI. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </main>
