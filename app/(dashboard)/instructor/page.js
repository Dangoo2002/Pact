...
export default function InstructorDashboard() {
  ...
  const classData = {
    ...
    performanceTrend: [
      { week: 'Week 1', avg: 65, target: 70 },
      { week: 'Week 2', avg: 68, target: 72 },
      { week: 'Week 3', avg: 71, target: 74 },
      { week: 'Week 4', avg: 74, target: 76 },
      { week: 'Week 5', avg: 76, target: 78 },
    ],
    distributionData: [
    ...
    atRiskStudents: [
      { id: 1, name: 'John Doe', mastery: 34, lastActive: '2 days ago', email: 'john@example.com' },
      { id: 2, name: 'Jane Smith', mastery: 28, lastActive: '5 days ago', email: 'jane@example.com' },
      { id: 3, name: 'Mike Johnson', mastery: 41, lastActive: '1 day ago', email: 'mike@example.com' },
    ]
  };
      ...
      <div className="md:ml-64">
        ...
        <div className="p-4 md:p-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 mb-6">
            <StatCard title="Total Students" value={classData.totalStudents} icon={Users} change="+8" color="blue" />
            <StatCard title="Active Students" value={classData.activeStudents} icon={Users} change="+5" color="green" />
            <StatCard title="Average Mastery" value={`${classData.averageMastery}%`} icon={Brain} change="+4%" color="purple" />
            <StatCard title="Pending Reviews" value={classData.pendingAssignments} icon={FileText} change="3 new" color="orange" />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 md:p-5">
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie
                      ...
                      labelLine={false}
                    >
                      {classData.distributionData.map((entry, index) => (
              ...
              <div className="flex flex-wrap justify-center gap-3 mt-4">
                {classData.distributionData.map((item, idx) => (
                ...
                {classData.atRiskStudents.map((student) => (
                  <div key={student.id} className="bg-white/5 backdrop-blur-sm border border-red-500/20 rounded-xl p-3 hover:border-red-500/40 transition-all duration-300">
                    ...
                    <div className="flex gap-2">
                      <button className="flex-1 text-xs px-2 py-1.5 rounded-lg bg-red-500/20 border border-red-500/30 text-red-400 hover:bg-red-500/30 transition">
                        Send Message
                      </button>
                      <button className="flex-1 text-xs px-2 py-1.5 rounded-lg bg-white/5 border border-white/10 text-gray-400 hover:text-white transition">
                        View Details
                      </button>
                    </div>
                  </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 hover:border-purple-500/30 transition-all duration-300 cursor-pointer">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">{classData.pendingAssignments} pending reviews</p>
                </div>
